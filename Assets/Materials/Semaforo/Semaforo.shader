...
Shader "Shader Forge/PEV_04_Masks" {
    Properties {
        ...
        [HDR]_ColorRojo ("Color Rojo", Color) = (7.129739,0,0,1)
        [HDR]_ColorVerde ("Color Verde", Color) = (0,1,0,1)
        [MaterialToggle] _IsRed ("IsRed", Float ) = 0
        _ColorBlack ("Color Black", Color) = (0,0,0,1)
        [MaterialToggle] _IsGree ("IsGree", Float ) = 0
        [MaterialToggle] _IsBlue ("IsBlue", Float ) = 0
        [HDR]_Color_Y ("Color_Y", Color) = (1,1,0,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Lighting:
                ...
                float Mask_Y = node_3210;
                float node_1441 = Mask_Y;
                float3 finalColor = (lerp( _ColorBlack.rgb, (_ColorRojo.rgb*Mask_R), _IsRed )+lerp( _ColorBlack.rgb, (_ColorVerde.rgb*Mask_G), _IsGree )+lerp( _ColorBlack.rgb, (_Color_Y.rgb*node_1441), _IsBlue ));
